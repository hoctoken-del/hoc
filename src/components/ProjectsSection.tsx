          ...
          <div className="grid lg:grid-cols-2">
            ...
            >
              <div
                ...
                style={{
                  background:
                    'radial-gradient(ellipse at center, oklch(0.42 0.19 265 / 0.15) 0%, transparent 70%)',
                }}
              />
            ...
            <div className="p-8 lg:p-10 flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                >
                  <Smartphone
                    size={18}
                    style={{ color: 'oklch(0.7 0.15 265)' }}
                  />
                </div>
              ...
              >
                An AI-powered mobile app currently in development for Android
                and iOS, designed to become a next-generation digital
                ecosystem. HOC transforms real-world human activities into
                digital rewards through a transparent and intelligent platform.
                Users can create their own private network and benefit from its
                stable income, the app has its own token, and users can make
                transactions and even make daily purchases using the app.
              </p>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = 'oklch(0.85 0.15 265)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = 'oklch(0.7 0.15 265)';
                }}
              >
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(to bottom, transparent 40%, oklch(0.115 0.008 265) 100%)',
                }}
              />
            </div>
            ...
            <div className="p-7">
              ...
              >
                A green energy technology project designed and developed by
                the founder. The system has been tested by an independent
                laboratory (EPIL) according to the project information provided
                by the founder. This system can achieve very high efficiency by
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  background:
                    'radial-gradient(ellipse at center, oklch(0.42 0.19 265 / 0.12) 0%, transparent 70%)',
                }}
              />
            ...
            <div className="p-7">
              ...
              >
                A software project designed to organize and manage company
                information and enable structured access and sharing. Built to
                streamline internal operations and provide a clear, auditable
                record of organizational data.
              </p>
            </div>
          </div>
        </div>
