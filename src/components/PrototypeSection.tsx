...
const SCREENSHOTS = [
  { src: '/manus-storage/app-screen-3_9a2bde8e.jpg', label: 'Movement Ledger' },
  { src: '/manus-storage/app-screen-1_e1f0dce7.jpg', label: 'Dashboard' },
  { src: '/manus-storage/app-screen-2_4230d3aa.jpg', label: 'Profile' },
  { src: '/manus-storage/app-screen-4_d501ee2f.jpg', label: 'Achievements' },
];
